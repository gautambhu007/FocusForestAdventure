...
- **Word Hunt** — forty picture word searches in four stages (5×5 horizontal-only for age 4 up to 10×10 with a couple of backwards words at 6–7+), every target word unique across the campaign, grids generated from a seed so no two plays match, drag-to-line selection that forgives a wobbly finger, and a picture beside every word so a pre-reader can play. Reported to parents as pages finished, stars and words found. Brief and study in `docs/WordSearch/`
