...
//  story name, `.shapeCount` is the rule that generates it. Adding a chapter
...
enum BrainlandStory {
    ...
    private static let forest = WorldStory(
        ...
        chapters: [
            ...
            StoryChapter(id: "forest.acorns", title: String(localized: "Hidden Acorns"), kind: .shapeCount,
                         blurb: String(localized: "Sammy hid his acorns — count them all!")),
            ...
            StoryChapter(id: "forest.river", title: String(localized: "River Crossing"), kind: .missingTile,
                         blurb: String(localized: "A stepping stone is missing from the river.")),
    ...
    private static let pirate = WorldStory(
        ...
        chapters: [
            StoryChapter(id: "pirate.maze", title: String(localized: "Treasure Maze"), kind: .missingTile,
                         blurb: String(localized: "A tile of the map path is missing.")),
            ...
            StoryChapter(id: "pirate.bridge", title: String(localized: "Bridge Building"), kind: .completePattern,
                         blurb: String(localized: "The rope bridge needs one more plank.")),
    ...
    private static let space = WorldStory(
        ...
        chapters: [
            ...
            StoryChapter(id: "space.satellite", title: String(localized: "Build the Satellite"), kind: .missingTile,
                         blurb: String(localized: "One panel of the satellite is missing.")),
            ...
            StoryChapter(id: "space.shaperotation", title: String(localized: "Shape Rotation"), kind: .rotateShape,
                         blurb: String(localized: "Spin it one more turn.")),
            StoryChapter(id: "space.moon", title: String(localized: "Moon Landing"), kind: .missingTile,
                         blurb: String(localized: "Find the safe landing tile.")),
            ...
            StoryChapter(id: "space.robot", title: String(localized: "Build the Robot"), kind: .buildSymmetry,
                         blurb: String(localized: "Pixel needs both sides to match."))
        ],
    ...
    private static let castle = WorldStory(
        ...
        chapters: [
            ...
            StoryChapter(id: "castle.maze", title: String(localized: "Wizard Maze"), kind: .missingTile,
                         blurb: String(localized: "Complete the path through the tower.")),
    ...
    private static let dinosaur = WorldStory(
        ...
        chapters: [
            ...
            StoryChapter(id: "dino.find", title: String(localized: "Find the Dino"), kind: .shapeCount,
                         blurb: String(localized: "Count how many are hiding here.")),
            StoryChapter(id: "dino.memory", title: String(localized: "Memory Cards"), kind: .sameOrDifferent,
                         blurb: String(localized: "Were those two the same?")),
            StoryChapter(id: "dino.bones", title: String(localized: "Hidden Bones"), kind: .shapeCount,
                         blurb: String(localized: "How many bones in the dig site?")),
            StoryChapter(id: "dino.skeleton", title: String(localized: "Build the Skeleton"), kind: .buildSymmetry,
                         blurb: String(localized: "Both sides of a dinosaur match.")),
            ...
            StoryChapter(id: "dino.volcano", title: String(localized: "Volcano Escape"), kind: .missingTile,
                         blurb: String(localized: "Complete the escape path!")),
            StoryChapter(id: "dino.nest", title: String(localized: "Nest Builder"), kind: .patternMatrix,
                         blurb: String(localized: "Lay the nest out just right."))
        ],
    ...
    private static let ocean = WorldStory(
        ...
        chapters: [
            ...
            StoryChapter(id: "ocean.pearls", title: String(localized: "Find the Pearls"), kind: .shapeCount,
            ...
            StoryChapter(id: "ocean.pipe", title: String(localized: "Pipe Puzzle"), kind: .missingTile,
                         blurb: String(localized: "The water pipe is missing a piece.")),
            ...
            StoryChapter(id: "ocean.submarine", title: String(localized: "Submarine Path"), kind: .missingTile,
                         blurb: String(localized: "Complete the route through the deep.")),
            ...
            StoryChapter(id: "ocean.memory", title: String(localized: "Sea Memory"), kind: .sameOrDifferent,
    ...
    private static let ice = WorldStory(
        ...
        chapters: [
            StoryChapter(id: "ice.maze", title: String(localized: "Ice Maze"), kind: .missingTile,
                         blurb: String(localized: "One slab of ice is missing from the path.")),
            StoryChapter(id: "ice.crystal", title: String(localized: "Crystal Rotation"), kind: .rotateShape,
                         blurb: String(localized: "The crystal turns as it catches the light.")),
            ...
            StoryChapter(id: "ice.blocks", title: String(localized: "Frozen Blocks"), kind: .patternMatrix,
                         blurb: String(localized: "The ice blocks alternate.")),
            ...
            StoryChapter(id: "ice.hidden", title: String(localized: "Hidden Pattern"), kind: .ravenMatrix,
    ...
    private static let volcano = WorldStory(
        ...
        chapters: [
            ...
            StoryChapter(id: "volcano.mazememory", title: String(localized: "Maze and Memory"), kind: .missingTile,
                         blurb: String(localized: "Remember the path, then finish it.")),
            StoryChapter(id: "volcano.logicrotation", title: String(localized: "Logic and Rotation"), kind: .rotateShape,
            ...
            StoryChapter(id: "volcano.hiddencount", title: String(localized: "Hidden and Counting"), kind: .shapeCount,
